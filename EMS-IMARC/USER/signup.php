...
$query=mysqli_query($con,"insert into tblemployees (EmailId,Password,Status,id)value('$uname','$password','$status','$rowcount')");
 if ($query) {
	 echo "successfull";
 }
 else{
        ...
        <div class="mn-content fixed-sidebar">
            ...
            <aside id="slide-out" class="side-nav white fixed">
                ...
                <ul class="sidebar-menu collapsible collapsible-accordion" data-collapsible="accordion" style="">
                    ...
                    <li class="no-padding"><a class="waves-effect waves-grey" href="signup.php"><i class="material-icons">account_box</i>Employee Signup</a></li>
